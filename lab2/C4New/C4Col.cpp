...
/*C4Col::~C4Col() { // deconstructor needed because new and delete are used
  ...
  */ // no longer need deconstructor because overloading
...
C4Col C4Col::operator+=(char){ // overloading += operator
    char newDisc;
    addDisc(newDisc);
    return (*this);
}
...
/*
   ...
   ostream &operator<<(ostream & output, const C4Board & B){
