...
class NDVector {
    public:
        ...
        T& operator[](int offset){ if (offset < 0 || offset > size-1) {throw 10;} return ptr[offset];}
        const T& operator[](int offset) const{
            return ptr[offset];}
        // checks that element exists and is not negative
        ...
        void doubleVec(); // doubles one vector
